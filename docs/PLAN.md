...
- **Done in current polish branch:** **`polish`** (README setup docs, feed/profile empty states, skeleton loading, inline composer feedback, custom 404, responsive pass). OAuth deferred — todo **`auth`** open; **`middleware`** remains open.
